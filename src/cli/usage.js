...
Usage:
  repwrk clone [--owner <owner>] [--filter <glob>] [--branch <branch>] [--yes]
...
Options:
  ...
  --yes               Do not ask before cloning into a directory that holds
                      files or directories which are not repositories
  --help              Show this help
